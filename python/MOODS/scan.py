...
def scan_best_hits_dna(seq, matrices, target, iterations=10, MULT=3, LIMIT_MULT=10, window_size=7):
...
class Scanner(_object):
    ...
    def variant_matches(self, seq, variants):
        return _scan.Scanner_variant_matches(self, seq, variants)

    def counts_max_hits(self, s, max_hits):
        return _scan.Scanner_counts_max_hits(self, s, max_hits)
